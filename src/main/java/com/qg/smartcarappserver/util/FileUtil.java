package com.qg.smartcarappserver.util;
...
public class FileUtil {
    ...
    public static File[] getFilesByPathAndSuffix(File path, final String sufixStr) {
        return path.listFiles((dir, name) -> sufixStr.isEmpty() || (dir.isDirectory() && name.endsWith(sufixStr)));
    }
     ...
     * @return
     */
    public static File[] getFilesByPathAndSuffix(String pathStr, final String sufixStr) {
